package com.lei.andlibs.drawables;


import com.lei.andlibs.R;
...
public class SVGLoader  {
    ...
    public static void load(Context context) {
        ...
        add(context, R.drawable.ic_android_black_24dp, SVGDrawable.SVGDrawableConstantState.create(new ic_android_black_24dp(context)));
    }
