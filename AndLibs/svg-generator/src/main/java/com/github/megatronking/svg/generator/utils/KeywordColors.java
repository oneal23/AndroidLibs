 ...
 * @since 2016/11/24 15:07
 */

public interface KeywordColors {
    ...
    int slategrey = 0xFF708090;
    int snow = 0xFFFFFAFA;
    int springgreen = 0xFF4682B4;
    int steelblue = 0xFFD2B48C;
    int tan = 0xFFFFFAFA;
    int teal = 0xFF008080;
